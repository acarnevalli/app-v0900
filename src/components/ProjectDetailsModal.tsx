        ...
        <div className="p-8 space-y-6">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="space-y-2">
              <div>
                ...
                <p className="font-medium text-gray-900">{project.clientname || 'Não identificado'}</p>
              </div>
            </div>
          </div>
              ...
              <div className="bg-green-50 rounded-lg p-4 border border-green-100">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-green-900">{project.paymentterms.installments}x</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  {project.paymentterms.paymentmethod && (
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold text-green-900">{project.paymentterms.paymentmethod}</span>
                    </div>
                  )}
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-orange-50 rounded-lg p-4 border border-orange-100">
              ...
              <p className="text-lg font-bold text-orange-900">{formatDate(project.startdate)}</p>
            </div>

            <div className="bg-purple-50 rounded-lg p-4 border border-purple-100">
              <h3 className="font-bold text-purple-900 mb-2">📅 Data de Entrega</h3>
              <p className="text-lg font-bold text-purple-900">{formatDate(project.enddate)}</p>
            </div>
          </div>
          ...
          {project.profitmargin !== undefined && (
            <div className="bg-green-50 rounded-lg p-4 border border-green-100">
              ...
              <p className="text-lg font-bold text-green-900">{project.profitmargin}%</p>
            </div>
          )}
